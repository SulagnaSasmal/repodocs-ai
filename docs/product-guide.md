...
- Technical writers working in Git-based documentation workflows
...
Normal documentation template packs usually stop at static files.

RepoDocs AI adds:

- reusable templates across product, feature, API, governance, operations, and architecture docs
...
1. Read `docs/installation.md` for setup.
2. Review `docs/ready-to-install-system.md` for the full product walkthrough.
3. Open `docs/product-specification.md` for the formal spec.
4. Use `templates/`, `prompts/`, and `examples/` to adapt the system into your own repository.